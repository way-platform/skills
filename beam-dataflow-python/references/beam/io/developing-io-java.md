...
page_title: "Apache Beam: Developing I/O connectors for Java"
...
in Beamâs [DatastoreIO](https://beam.apache.org/releases/javadoc/current/index.html?org/apache/beam/sdk/io/gcp/datastore/DatastoreIO.html)
...
abstract methods in Beamâs implementations for Cloud BigTable
...
_checkpointing_ for failure recovery, _record IDs_ to prevent data duplication,
and _watermarking_ for estimating data completeness in downstream parts of your
pipeline.
